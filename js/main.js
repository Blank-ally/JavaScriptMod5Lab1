...
$(function () {
    ...
    const htmlEleOne = $('#htmlOne').html();
    console.log(htmlEleOne);
    ...
    $('#textMethodParagraph').text(" updated with the text() method.")
...
$('.eachTest p').each(function(e){
   console.log($(this).text());
  
})

console.log($('.eachTest p').text())
